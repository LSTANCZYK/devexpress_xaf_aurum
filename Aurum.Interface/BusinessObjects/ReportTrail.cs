...
namespace Audit
{
    ...
    public class ReportTrail : XPObject
    {
        ...
        public ReportTrail() : base() { }
        public ReportTrail(Session session) : base(session) { }
        ...
        {
            get { return reportId; }
            set { SetPropertyValue("ReportId", ref reportId, value); }
        }
        ...
        public static void LogOperation(IObjectSpace objectSpace, string reportId, ReportParametersObjectBase parameters)
        {
            var trail = objectSpace.CreateObject<Audit.ReportTrail>();
            trail.Time = DateTime.Now;
            trail.ReportId = reportId;
            trail.Clientname = GetComputerName();
            trail.Username = SecuritySystem.CurrentUserName;
            trail.OsUser = GetLoginName();
            trail.Parameters = ConvertParamsToString((XPObjectSpace)objectSpace, parameters);
            objectSpace.CommitChanges();
        }

        private static string ConvertParamsToString(XPObjectSpace objectSpace, ReportParametersObjectBase p)
        {
